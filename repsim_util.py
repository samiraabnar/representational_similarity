"""Representational Similarity Utils.


Implementations of CCA related functions are copied from this repo:
https://github.com/google/svcca

Implementations of CKA related functions are copied from this repo:
